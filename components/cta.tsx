        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              ...
              data-aos="fade-up"
            >
              Step into the future of tech-driven solutions
            </h2>
            <p className="text-indigo-200/65 pb-6">
              Join our platform to experience tools built with a passion for innovation, tailored to empower every creative and technical journey.
            </p>
