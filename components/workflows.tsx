        ...
        <div className="pb-12 md:pb-20">
          ...
          <Spotlight className="group mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3">
            ...
            <WorkflowCard
              ...
              description="Effortlessly grow your product while keeping consistency across different platforms."
            />
            <WorkflowCard
              imageSrc={WorflowImg03}
              title="Tailored Flows"
              description="Customize workflows to match your team's style and efficiency."
            />
          </Spotlight>
        </div>
      </div>
